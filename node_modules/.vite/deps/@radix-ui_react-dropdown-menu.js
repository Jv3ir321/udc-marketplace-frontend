...
import {
  ...
  hideOthers,
  useFocusGuards
} from "./chunk-T2Y2HA63.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState,
  useId
} from "./chunk-RTXYONFF.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-CUEFHPTF.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-ICCSOK3K.js";
import {
  createSlot,
  useComposedRefs
...
var Menu = __name4((props) => {
  ...
  React5.useEffect(() => {
    const handleKeyDown = __name4(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name4(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React5.useEffect(() => {
    ...
    const handleBlur = __name4(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React5.forwardRef(
  __name4(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React5.forwardRef(
  __name4(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React5.forwardRef(
  ...
  __name4(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
...
var MenuRootContentNonModal = React5.forwardRef(__name4(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  return (0, import_jsx_runtime3.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name4((key) => {
      var _a, _b;
...
var MenuGroup = React5.forwardRef(
  __name4(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React5.forwardRef(
  __name4(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React5.forwardRef(
  __name4(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name4(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React5.forwardRef(
  __name4(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React5.forwardRef(
  __name4(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React5.forwardRef(
  __name4(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React5.forwardRef(
  __name4(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React5.forwardRef(
  __name4(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React5.forwardRef(
  __name4(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
...
__name4(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name4(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name4(getCheckedState, "getCheckedState");
...
__name4(getNextMatch, "getNextMatch");
...
__name4(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name4(whenMouse, "whenMouse");
var Root3 = Menu;
...
var DropdownMenu = __name5((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name5((props) => {
...
var DropdownMenuContent = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime4.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React6.forwardRef(__name5(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime4.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React6.forwardRef(__name5(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime4.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React6.forwardRef(__name5(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime4.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React6.forwardRef(__name5(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime4.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React6.forwardRef(__name5(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime4.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name5((props) => {
...
var DropdownMenuSubTrigger = React6.forwardRef(__name5(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime4.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React6.forwardRef(__name5(function DropdownMenuSubContent2(props, forwardedRef) {
